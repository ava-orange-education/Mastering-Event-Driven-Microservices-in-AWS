...
private final Region region = Region.EU_CENTRAL_1;
	...
	private SnsClient snsClient = SnsClient.builder()
            .region(region)
            .build();
	...
	public APIGatewayV2HTTPResponse handleRequest(APIGatewayV2HTTPEvent event, Context context) {
		...
		// send OrderCreated message to SNS
		var pubRequest = PublishRequest.builder()
                .topicArn("arn:aws:sns:" + region + ":" + context.getInvokedFunctionArn().split(":")[4] + ":OrderCreatedTopic")
