...
public class CdkExampleStack extends Stack {
    ...
    private Archive createOrderingSystemEventBusArchive(String name, String archiveName, EventBus sourceEventBus) {
    	var archive = Archive.Builder.create(this, name)
    ...
    public CdkExampleStack(final Construct scope, final String id, final StackProps props) {
        ...
        var orderingSystemEventBusArchive = createOrderingSystemEventBusArchive(
        		"EventBridge_OrderingSystemEventBusArchive",
        		"OrderingSystemEventBus_Archive",
        		orderingSystemEventBus);
        ...
        new CfnOutput(this, "SQS_OrderingSystemEventBusArchiveArn", CfnOutputProps.builder()
                .value(orderingSystemEventBusArchive.getArchiveArn())
                .build());
    }
}
