...
public class CdkExampleStack extends Stack {
    ...
    public CdkExampleStack(final Construct scope, final String id, final StackProps props) {
        ...
        var rollbackServiceFunction = createLambdaFunction(
        		"Lambda_RollbackService", 
        		"rollback-service", 
        		"../software/microservices/rollback-service/target/rollback-service.jar");
        ...
        new CfnOutput(this, "Lambda_RollbackService_ARN", CfnOutputProps.builder()
                .value(rollbackServiceFunction.getFunctionArn())
                .build());
