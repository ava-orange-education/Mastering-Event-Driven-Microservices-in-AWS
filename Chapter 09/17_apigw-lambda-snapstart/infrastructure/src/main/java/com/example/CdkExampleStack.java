...
public class CdkExampleStack extends Stack {
    ...
    private Alias createNewOrderServiceLambdaFunctionAlias(Function lambda) {
    	var currentVersion = lambda.getCurrentVersion();
        
    	var alias = Alias.Builder.create(this, "Lambda_NewOrderService_Alias")
        		.aliasName("prod")
    ...
    private RestApi createOrderingPlatformApi(IFunction newOrderServiceLambdaFunction) {
    ...
    public CdkExampleStack(final Construct scope, final String id, final StackProps props) {
        ...
        var newOrderServiceLambdaFunctionAlias = createNewOrderServiceLambdaFunctionAlias(newOrderServiceLambdaFunction);
        var orderingPlatformApi = createOrderingPlatformApi(newOrderServiceLambdaFunctionAlias);
